...
void dataReport() {
  dashSerial.print("tData");
  dashSerial.print(',');
  dashSerial.print(loopCount);
  dashSerial.print(',');
  dashSerial.print(trialTime);
  dashSerial.print(',');
  dashSerial.print(stateTime);
  dashSerial.print(',');
  dashSerial.print(knownValues[0]); //state
  dashSerial.print(',');
  dashSerial.print(knownValues[8]);  //load cell
  dashSerial.print(',');
  dashSerial.print(knownValues[10]); // lick sensor
  dashSerial.print(',');
  dashSerial.print(knownValues[9]); // motion
  dashSerial.print(',');
  dashSerial.println(scopeState);
}
